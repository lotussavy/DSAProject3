...
Description:
Sequence class that supports random access like an array,and also allows dynamic insertion 
and removal of new elements is implemented. Prototypes of the class along with their data and member fucntion
are given in the sequence.h. The details of all the member fucntion is implemented in the sequence.cpp.
project3TestHarness.cpp is used to test all the function that are implemented
*/
